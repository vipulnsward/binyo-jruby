...
public class Errors {
    ...
    public static RaiseException newByteError(Ruby rt, String message) {
        return newError(rt, "Binyo::ByteError", message);
    }
    
    public static RaiseException newByteListError(Ruby rt, String message) {
        return newError(rt, "Binyo::ByteListError", message);
    }
